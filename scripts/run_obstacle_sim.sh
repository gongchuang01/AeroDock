...
nohup setsid sh -c "tail -n 0 -f $CMD_FILE | env SVGA_VGPU10=0 HEADLESS=1 PX4_GZ_WORLD=aerodock_obstacles PX4_GZ_MODEL_POSE=0,0,0.5 make -C $AERODOCK_HOME/PX4-Autopilot px4_sitl gz_x500_lidar_2d" > "$LOG_DIR/obstacle-sim.log" 2>&1 &
...
echo "Obstacle SITL ready: AeroDock obstacle world + 2D lidar bridged to ROS 2."
